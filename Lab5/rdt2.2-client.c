...
* Name: Yihui QIn
* Date: 02/03/2020
* Title: Lab4 - UDP stop-and-wait client
* Description: This program computes the the RDT2.2 client-side socket interface, which takes care of
               corruption, duplicated packets.
*/
